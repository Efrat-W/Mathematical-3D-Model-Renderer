...
class DepthOfFieldTests {
	...
	void testDepthOfField2() {
		...
		scene.geometries.add(//
				...
				new Sphere(new Point(5, -7, 900), 6).setEmission(new Color(PINK)) //
				.setMaterial(new Material().setKd(0.8).setKs(0.4).setShininess(200).setKr(0.01)),
				new Triangle(new Point(0.5,-30, 900),new Point(-0.5,-30, 900),new Point(0.,0, 880)).setEmission(new Color(GREEN)),
				...
				.setMaterial(new Material().setKd(0.8).setKs(0.2).setShininess(200).setKr(0.1)),
				new Triangle(new Point(-29.5,-30, 800),new Point(-30.5,-30, 800),new Point(-30,0, 780)).setEmission(new Color(GREEN)),
				...
				.setMaterial(new Material().setKd(0.8).setKs(0.2).setShininess(200).setKr(0.1)),
				new Triangle(new Point(49.5,-30, 700),new Point(50.5,-30, 700),new Point(50,0, 680)).setEmission(new Color(GREEN)),
