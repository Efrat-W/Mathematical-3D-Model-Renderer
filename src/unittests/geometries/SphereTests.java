...
class SphereTests {
	...
	public void testFindIntersections() {
	    ...
	    assertNull(sphere.findIntersections(new Ray(new Point(2.5, -1, 0.8),
		    new Vector(3, -1, 1))),
	    ...
	    List<Point> result3 = sphere.findIntersections(new Ray(new Point(0,0,0),
		    new Vector(1,-1,0)));
	    assertEquals(1, result3.size(), "Wrong number of points");
	    assertEquals(p4, result3.get(0), "Ray crosses sphere from inside incorrectly.");
	    
	    // TC12: Ray starts at sphere and goes outside (0 points)
	    assertNull(sphere.findIntersections(new Ray(new Point(1.59,-58,0.57),
		    new Vector(-0.19,-0.85,1))),
	    ...
	    List<Point> result4 = sphere.findIntersections(new Ray(new Point(1,0,-2),
		    new Vector(0,0,1)));
	    assertEquals(2, result.size(), "Wrong number of points");
	    if (result.get(0).getX() > result.get(1).getX())
	    ...
	    List<Point> result6 = sphere.findIntersections(new Ray(new Point(1,-0.5,0),
		    new Vector(0,1.5,0)));
	    ...
	    List<Point> result7 = sphere.findIntersections(new Ray(new Point(1,0,0),
		    new Vector(0,1,0)));
	    ...
	    assertNull(sphere.findIntersections(new Ray(new Point(1,0,1),
		    new Vector(0,0,1))),
		    "Ray's direction through center, line out of sphere and starts on sphere surface");
	    
	    // TC18: Ray starts after sphere (0 points)
	    assertNull(sphere.findIntersections(new Ray(new Point(1,0,1.5),
		    new Vector(0,0,1))),
	    ...
	    assertNull(sphere.findIntersections(new Ray(new Point(2, -2, 0),
		    new Vector(-1,0,0))),
